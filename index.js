...
function dbSelect(){
  const sql = `SELECT sid, firstname, lastname, mobile, length(sid) AS length_sid, length(firstname) AS length_firstname, length(lastname) AS length_lastname, length(mobile) AS length_mobile FROM target_send`
